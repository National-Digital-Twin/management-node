 ...
 * provide. Starts a Postgres container per test class, points the Spring context at
 * it, and re-enables Flyway (disabled in the shared profile) so migrations apply for
 * real.
 */
@DataJpaTest
